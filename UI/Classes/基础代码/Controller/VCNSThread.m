...
-(void)threadAction:(NSThread*)thread{
    ...
    while (true) {
        ...
        _counter++;
         YCLog(@"thread-----_counter==%d",(int)_counter);
    }
    
     YCLog(@"thread--finish---_counter==%d",(int)_counter);
}
...
-(void)threadAction1:(NSThread*)thread{
    ...
    while (true) {
        ...
        _counter++;
        [_lock unlock];
        YCLog(@"thread1-----_counter==%d",(int)_counter);
    }
    YCLog(@"thread1--finish---_counter==%d",(int)_counter);
}
...
-(void)threadAction2:(NSThread*)thread{
 int i = 0;
    while (true) {
        ...
        _counter++;
        [_lock unlock];
        YCLog(@"thread2-----_counter==%d",(int)_counter);
    }
    YCLog(@"thread2--finish---_counter==%d",(int)_counter);
}
