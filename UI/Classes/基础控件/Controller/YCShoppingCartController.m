...
- (void)viewDidLoad {
    [super viewDidLoad];
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 100, kScreenWidth, kScreenHeight) style:UITableViewStylePlain];
    ...
    UIView *bottomLayout = [[UIView alloc]initWithFrame:CGRectMake(0, kScreenHeight-130, kScreenWidth, 50)];
    ...
    UIView *line = [[UIView alloc]initWithFrame:CGRectMake(0, kScreenHeight-130, kScreenWidth, 1)];
