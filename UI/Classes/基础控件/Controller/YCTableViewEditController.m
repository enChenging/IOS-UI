...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 150, kScreenWidth, kScreenHeight) style:UITableViewStylePlain];
    ...
    for (int i = 0; i<5; i++) {
        _alertBtn = [[UIButton alloc]initWithFrame:CGRectMake(70*i+10, 100, 65, 30)];
        if (i == 0) {
